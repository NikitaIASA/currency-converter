      ...
      <div className={classes.header__inner}>
        ...
        <div className={classes.actualInfo}>
          <ul className={classes.actualInfo__rates}>
            <li>
              1 USD = <b>{(1 / currencyRates.USD).toFixed(2)}</b> UAH
            </li>
            <li>
              1 EUR = <b>{(1 / currencyRates.EUR).toFixed(2)}</b> UAH
            </li>
          </ul>
          <p className={classes.actualInfo__date}>
            Last update was: {dateOfLastUpdate} UTC
          </p>
        </div>
      </div>
    </header>
